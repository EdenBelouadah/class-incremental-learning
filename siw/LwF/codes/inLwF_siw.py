...
for batch_number in range(1, S + 1):
    ...
    # print(np_model_weights.shape)
    # print(np_model_bias.shape)
    # normalized_np_model_weights = preprocessing.normalize(np_model_weights, axis=0, norm='l2')
    # normalized_np_model_bias = preprocessing.normalize(np_model_bias, norm='l2')
    ###############################################################################################
