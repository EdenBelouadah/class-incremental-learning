...
for batch_number in range(1, S + 1):
    ...
    normalized_np_model_weights = preprocessing.normalize(rectified_np_model_weights, axis=0, norm='l2')
    normalized_np_model_bias = preprocessing.normalize(rectified_np_model_bias, norm='l2')
    ###############################################################################################
    ...
    for (val_path_line, val_feat_line) in zip(val_images_paths_file, val_images_features_file):
        ...
        rectified_val_np_scores = val_np_feat.dot(normalized_np_model_weights) + normalized_np_model_bias
