...
with warnings.catch_warnings(record=True) as warn_list:
    ...
    for b in range(first_batch_number, last_batch_number +1):
        ...
        if b >= 2 :
            ...
            old_train_file_path = os.path.join(dataset_files_dir,'unbalanced/train','k'+str(K), str(b) + '_old')
            new_train_file_path = os.path.join(dataset_files_dir,'unbalanced/train','k'+str(K), str(b) + '_new')
        ...
        for i in range(1, b + 1):
            ...
            # Model
            model = models.resnet18(pretrained=False, num_classes=P * i)
