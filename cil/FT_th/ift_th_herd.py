...
if len(sys.argv) != 9:
    print('Arguments: fine_tuning_scores_path, exemplars_files_path, K, P, S, Dataset_name [vgg_faces|ilsvrc|google_landmarks], first_batch_number [2-, last_batch_number')
    sys.exit(-1)
#Parameters###############################
batch_size = 256
...
for batch_number in range(first_batch, last_batch + 1):
    ...
    print('*****************************************************')
    #train
    old_train_images_paths_file = os.path.join(exemplars_files_path,dataset + '/S~' + str(S) + '/K~' + memory_size + '/' + str(batch_number) + '_old')

    new_train_images_paths_file = images_list_files_path + dataset + '/S~' + str(S) + '/separated/train/batch'+ str(batch_number)
    # Val
    ...
    # print(old_train_images_scores_file)
    # print(old_train_images_paths_file)
    ###############################################################################################
