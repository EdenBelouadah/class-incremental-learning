...
for itera in range(nb_groups):
    ...
    accuracies.append(float(np.average(stat_icarl)))
    hb1_accuracies.append(float(np.average(stat_hb1)))
    ...
    output_file.write('iCaRL accuracies =  '+ str([float(str(e)[:6]) for e in accuracies])+'\n')
    print('iCaRL accuracies =  '+ str([float(str(e)[:6]) for e in accuracies]))
...
accuracies = [float(str(e)[:6]) for e in accuracies]
hb1_accuracies = [float(str(e)[:6]) for e in hb1_accuracies]
print('Hybrid1 Accuracies = '+str(hb1_accuracies))
output_file.write(' Hybrid1 Accuracies = '+str(hb1_accuracies)+'\n')
print('mean incremental accuracy = '+str(np.mean(np.array(hb1_accuracies[1:]))))
output_file.write('mean incremental accuracy = '+str(np.mean(np.array(hb1_accuracies[1:])))+'\n')
print('**************************')
print('iCaRL Accuracies = '+str(accuracies))
output_file.write(' iCaRL Accuracies = '+str(accuracies)+'\n')
print('mean incremental accuracy = '+str(np.mean(np.array(accuracies[1:]))))
output_file.write('mean incremental accuracy = '+str(np.mean(np.array(accuracies[1:])))+'\n')
